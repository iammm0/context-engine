...
import {
  useBatchDocumentUploadProgress,
  type UploadQueueItem,
  type UploadStatus,
} from "@/components/documents/use-batch-document-upload-progress"
...
export function BatchDocumentUpload({ knowledgeSpaceId, onDocumentUploaded, onDocumentSettled }: BatchDocumentUploadProps) {
  ...
  const { stopItemSubscriptions, subscribeProgress, subscribeTaskProgress, updateItem } = useBatchDocumentUploadProgress({
    onDocumentSettled,
    setQueue,
  })
